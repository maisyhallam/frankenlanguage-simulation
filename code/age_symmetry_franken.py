...
def generation_results(feature_symmetry_results):
    """Gives each generation of a kinship system a score of 1 or 0 for whether or not it uses an age distinction. A score is null if there wasn't enough information to tell."""
    results = {}
    gen1_values = []
    gen2_values = []
...
def main(argv):
    ...
    for i in range(int(argv)):
        ...
        write_headers('../data/frankenlanguages_age.csv')
        ...
        for file in files:
            ...
            write_full_csv('../data/frankenlanguages_age.csv',file + '_' + str(directory_counter),gen_results)
